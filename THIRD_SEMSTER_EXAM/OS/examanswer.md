Acha bro, 8-mark answer incoming — **expanded, clean, simple English**, with **tiny examples**, and **exam-perfect flow**.
Just copy this in your answer sheet and you’re golden. 💯🔥

---

# **⭐ 8-MARK ANSWER (FULLY EXPANDED + SIMPLE ENGLISH + EXAMPLES)**

# **1️⃣ Major Activities of an Operating System**
...
**Example:**
Saving a PDF, renaming a photo, or deleting a video — all are done through OS file management.
...
**Example:**
“USB not recognized” or "Low memory" notifications are given by the OS.
...
# **2️⃣ Advantages of Layered Approach to System Design**
...
**Example:**
One layer for memory, one for CPU scheduling — easy to follow.
...
**Example:**
Upgrading memory management doesn’t disturb the file system layer.
...
**Example:**
Just like arranging clothes in separate drawers — everything is organized.
